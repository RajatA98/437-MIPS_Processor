...
add wave -noupdate -expand -group {EM } /system_tb/DUT/CPU/DP/EM/emif/opcode_MEM
...
add wave -noupdate -expand -group {EM } -color Magenta -radix hexadecimal /system_tb/DUT/CPU/DP/emif/branch_addr
...
add wave -noupdate -expand -group MW /system_tb/DUT/CPU/DP/mwif/opcode_WB
...
add wave -noupdate -group {Hazard Unit} /system_tb/DUT/CPU/DP/HU/RegWr_EX
add wave -noupdate -group {Hazard Unit} /system_tb/DUT/CPU/DP/HU/memWr_EX
...
add wave -noupdate -group {Hazard Unit} -group itype -radix unsigned /system_tb/DUT/CPU/DP/HU/it_MEM
...
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/instr_EX
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/instr_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/instr_WB
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/RegWr_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/memWr_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/memtoReg_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/RegWr_WB
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/memtoReg_WB
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/Asel
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/Bsel
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/rt_EX
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/rt_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/rt_WB
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/it_EX
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/it_MEM
add wave -noupdate -group FU /system_tb/DUT/CPU/DP/FU/it_WB
...
add wave -noupdate -group ALU /system_tb/DUT/CPU/DP/deif/busA_EX
add wave -noupdate -group ALU /system_tb/DUT/CPU/DP/mwif/Output_Port_WB
add wave -noupdate -group ALU /system_tb/DUT/CPU/DP/emif/Output_Port_MEM
...
add wave -noupdate -group {Dcache signals} -expand -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/frame_a[0]} {-height 17 -childformat {{{/system_tb/DUT/CPU/CM/DCACHE/frame_a[0].tag} -radix hexadecimal}} -expand} {/system_tb/DUT/CPU/CM/DCACHE/frame_a[0].tag} {-height 17 -radix hexadecimal} {/system_tb/DUT/CPU/CM/DCACHE/frame_a[0].data} -expand} /system_tb/DUT/CPU/CM/DCACHE/frame_a
add wave -noupdate -group {Dcache signals} -expand -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/frame_b[0]} -expand {/system_tb/DUT/CPU/CM/DCACHE/frame_b[0].data} -expand} /system_tb/DUT/CPU/CM/DCACHE/frame_b
add wave -noupdate -group {Dcache signals} -expand -group {Flush Check} /system_tb/DUT/CPU/cif0/dload
add wave -noupdate -group {Dcache signals} -expand -group {Flush Check} -color Cyan /system_tb/DUT/CPU/CM/cif/dstore
add wave -noupdate -group {Dcache signals} -expand -group {Flush Check} -color Cyan /system_tb/DUT/CPU/CM/cif/daddr
add wave -noupdate -group {Dcache signals} -color {Orange Red} /system_tb/DUT/CPU/CM/DCACHE/hit
add wave -noupdate -group {Dcache signals} -color {Orange Red} /system_tb/DUT/CPU/CM/DCACHE/miss
add wave -noupdate -group {Dcache signals} -expand -group {dp connections} -color {Orange Red} /system_tb/DUT/CPU/CM/dcif/dhit
add wave -noupdate -group {Dcache signals} -expand -group {dp connections} -color {Orange Red} /system_tb/DUT/CPU/CM/dcif/flushed
add wave -noupdate -group {Dcache signals} -expand -group {dp connections} -color {Orange Red} /system_tb/DUT/CPU/CM/dcif/dmemload
add wave -noupdate -group {Dcache signals} -expand -group {dp connections} -color {Orange Red} /system_tb/DUT/CPU/CM/dcif/dmemstore
add wave -noupdate -group {Dcache signals} -expand -group {dp connections} -color {Orange Red} -radix binary /system_tb/DUT/CPU/CM/dcif/dmemaddr
add wave -noupdate -group {Dcache signals} -expand -group {memory connections} -color {Orange Red} /system_tb/DUT/CPU/CM/cif/dwait
add wave -noupdate -group {Ihit signals} -color Yellow /system_tb/DUT/CPU/CM/ICACHE/state
add wave -noupdate -group {Ihit signals} -color Yellow /system_tb/DUT/CPU/dcif/ihit
add wave -noupdate -group {Ihit signals} -color Yellow /system_tb/DUT/CPU/cif0/iwait
...
add wave -noupdate /system_tb/DUT/CPU/CM/DCACHE/used_a
add wave -noupdate /system_tb/DUT/CPU/CM/DCACHE/used_b
add wave -noupdate /system_tb/DUT/CPU/CM/DCACHE/valid_a
add wave -noupdate /system_tb/DUT/CPU/CM/DCACHE/valid_b
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {853481 ps} 0}
...
update
WaveRestoreZoom {654 ns} {1210 ns}
